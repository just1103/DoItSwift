...
class ViewController: UIViewController {
    ...
    @IBAction func btnMoveImageView(_ sender: UIButton) {
        ...
        // 1) tabBarController 프로퍼티 - *View Controller is embedded inside a Tab Bar Controller인 경우(즉, view controller가 tab bar controller의 자식 항목) 이 프로퍼티는 nil이 아님 (Optional UITabBarController type이므로 unwrap 필요)
